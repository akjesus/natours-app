...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWtqZXN1cyIsImEiOiJjbDZ4cDh2ZmUwMnZjM2NtcHV3czM0eXIwIn0.kHNfo9drMwLCiZwSpxDuLw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/akjesus/cl6yt0odq001g15r0v2snwbvv',
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showAlert)('caution', 'Logged Out!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateAccount.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {// location.reload(true);
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51LZeFeAsZRBt2uMtHpzEUPyRkmG9xQxJqPQciTojYe4N8lEVNmO3kYPP9gJW2ewueQFmDNEwE8ce7VBU87ujinNJ00o8hNvRHf');
...
var updatePass = document.querySelector('.form-user-settings');
...
if (updateBtn) {
  updateBtn.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateAccount.updateAccount)(form, 'data');
    ;
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateAccount.updateAccount)({
...
},{"./mapBox":"mapBox.js","./login":"login.js","./updateAccount":"updateAccount.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "49584" + '/');
